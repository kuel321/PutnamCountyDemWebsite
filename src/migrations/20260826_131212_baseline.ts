...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  await db.run(sql`CREATE TABLE \`pages_blocks_meeting_info\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_meeting_info_order_idx\` ON \`pages_blocks_meeting_info\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_meeting_info_parent_id_idx\` ON \`pages_blocks_meeting_info\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_meeting_info_path_idx\` ON \`pages_blocks_meeting_info\` (\`_path\`);`)
  ...
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_meeting_info\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_meeting_info_order_idx\` ON \`_pages_v_blocks_meeting_info\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_meeting_info_parent_id_idx\` ON \`_pages_v_blocks_meeting_info\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_meeting_info_path_idx\` ON \`_pages_v_blocks_meeting_info\` (\`_path\`);`)
  ...
  `)
  await db.run(sql`CREATE TABLE \`header_nav_items_nav_item_sub_links\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`header_nav_items_nav_item_sub_links_order_idx\` ON \`header_nav_items_nav_item_sub_links\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`header_nav_items_nav_item_sub_links_parent_id_idx\` ON \`header_nav_items_nav_item_sub_links\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`header_nav_items\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`nav_item_label\` text NOT NULL,
  	\`nav_item_type\` text DEFAULT 'link',
  	\`nav_item_link_type\` text DEFAULT 'reference',
  	\`nav_item_link_new_tab\` integer,
  	\`nav_item_link_url\` text,
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  await db.run(sql`DROP TABLE \`pages_blocks_meeting_info\`;`)
  await db.run(sql`DROP TABLE \`pages\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_content\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_meeting_info\`;`)
  ...
  await db.run(sql`DROP TABLE \`header_nav_items_nav_item_sub_links\`;`)
